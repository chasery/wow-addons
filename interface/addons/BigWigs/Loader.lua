...
do
	...
	local myGitHash = "e7c55b3" -- The ZIP packager will replace this with the Git hash.
	local releaseString = ""
	--[===[@alpha@
...
do
	...
	local DBMdotRevision = "17234" -- The changing version of the local client, changes with every alpha revision using an SVN keyword.
	local DBMdotDisplayVersion = "7.3.20" -- "N.N.N" for a release and "N.N.N alpha" for the alpha duration. Unless they fuck up their release and leave the alpha text in it.
